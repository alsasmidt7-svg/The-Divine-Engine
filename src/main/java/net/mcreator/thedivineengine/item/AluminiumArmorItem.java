...
public abstract class AluminiumArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_iron")), () -> Ingredient.of(new ItemStack(TheDivineEngineModItems.ALUMINIUMINGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("the_divine_engine:aluminiumarmor"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("the_divine_engine:aluminium_armor"), armorMaterial);
