...
public abstract class TitaniumArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_iron")), () -> Ingredient.of(new ItemStack(TheDivineEngineModItems.TITANIUMINGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("the_divine_engine:titaniumarmor"))), 2f, 0.3f);
			registerHelper.register(ResourceLocation.parse("the_divine_engine:titanium_armor"), armorMaterial);
